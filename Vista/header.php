...
<head>
    ...
    <title>Waliki |  Sistema de Registro de Historias Clinicas</title>
    ...
    <div class="header">
        ...
        <div class="header-left">
            <a href="index.php" class="logo">
                <img src="assets/img/logo.png" width="35" height="35" alt=""> <span>Waliki</span>
            </a>
        </div>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="active">
                        <a href="index.php"><i class="fa fa-dashboard"></i> <span>Principal</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="departamentos.php"><i class="fa fa-hospital-o"></i> <span>Departamentos</span></a>
                    </li>
                    <li class="submenu">
